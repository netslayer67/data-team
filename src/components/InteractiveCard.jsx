...
/**
 * Interactive Employee Card
 */
export const InteractiveEmployeeCard = ({
    employee,
    onClick,
    delay = 0
}) => {
    const [isHovered, setIsHovered] = useState(false);
    const statusTone = employee?.status === 'Active'
        ? 'bg-emerald-100 text-emerald-700'
    ...
    return (
        ...
        >
            ...
            >
                {/* Avatar */}
                <motion.div
                    className="w-12 h-12 rounded-full bg-gradient-to-br from-cyan-400 to-sky-500 flex items-center justify-center text-white font-semibold text-lg"
                ...
                <div className="flex-1 min-w-0">
                    ...
                    >
                        {employee.roleTitle || employee.role}
                    </motion.p>
                </div>
                ...
                <motion.div
                    ...
                    whileInView={{ opacity: 1, scale: 1 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.4, delay: delay + 0.3, type: 'spring', stiffness: 200 }}
                >
                    {employee.status}
                </motion.div>
            </motion.div>
